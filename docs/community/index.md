...
!!! tip "First-time contributor?"
    ...
    [:octicons-arrow-right-24: Good First Issues](https://github.com/shuans/cellon/labels/good%20first%20issue){ .md-button }
...
|:-------------|:------------|:----------------|
| :material-bug: **Report Bugs** | Found something broken? File an issue with reproduction steps. | [Open a Bug Report](https://github.com/shuans/cellon/issues/new?template=bug_report.md) |
| :material-lightbulb: **Request Features** | Have an idea for Cello? We would love to hear it. | [Open a Feature Request](https://github.com/shuans/cellon/issues/new?template=feature_request.md) |
| :material-code-tags: **Contribute Code** | Fix bugs, add features, or optimize Rust performance. | [Contributing Guide](contributing.md) |
| :material-book-open-variant: **Improve Docs** | Fix typos, add examples, clarify explanations. | [Edit on GitHub](https://github.com/shuans/cellon/tree/main/docs) |
...
-   :material-star:{ .lg .middle } **Stars**
    ...
    [:octicons-arrow-right-24: Star on GitHub](https://github.com/shuans/cellon)
...
-   :material-source-fork:{ .lg .middle } **Forks**
    ...
    [:octicons-arrow-right-24: Fork on GitHub](https://github.com/shuans/cellon/fork)
...
-   :material-account-multiple:{ .lg .middle } **Contributors**
    ...
    [:octicons-arrow-right-24: View Contributors](https://github.com/shuans/cellon/graphs/contributors)
...
-   :material-source-branch:{ .lg .middle } **Open Issues**
    ...
    [:octicons-arrow-right-24: View Issues](https://github.com/shuans/cellon/issues)
...
| :material-github: **GitHub Discussions** | Long-form questions, ideas, show-and-tell | [Discussions](https://github.com/shuans/cellon/discussions) |
...
| :material-rss: **RSS Feed** | Automated release notifications | [Releases Feed](https://github.com/shuans/cellon/releases.atom) |
...
!!! example "Ready to dive in?"
    ...
    The best way to join the community is to start building. Pick an [example](../examples/index.md), read the [getting started guide](../getting-started/index.md), or jump straight into the [open issues](https://github.com/shuans/cellon/issues).

    [:octicons-arrow-right-24: Get Started](../getting-started/index.md){ .md-button .md-button--primary }
    [:octicons-arrow-right-24: Browse Issues](https://github.com/shuans/cellon/issues){ .md-button }
