...
description: Implement security headers, Content Security Policy, rate limiting, JWT authentication, and secure sessions in Cello
---

# :material-shield-lock: Security Features
