...
description: Cellon v0.10.0 release notes - Advanced Patterns features
---
...
See the complete [Advanced patterns demo example](https://github.com/shuans/cello/blob/main/examples/advanced_patterns_demo.py) for a working application demonstrating all Advanced Patterns features.
